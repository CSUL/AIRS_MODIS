...
#            
#            
#            patch = thickness1[round]
#            patch = np.ma.array(patch, mask=patch < 0)   
#            mini = np.around(np.min(patch))
#            maxi = np.around(np.max(patch))  
#            fig.add_subplot(gs1[0])
#            cp = plt.contourf(patch,levels = np.arange(0, 55, 5), extend = 'both')
#            plt.title('TH | clouds: ' + str(cluster_count)  )
#            plt.ylabel('min: ' + str(mini)  +
#                      " max: " + str(maxi))
...
#            plt.title(str('PH ' + str(indices[round])))
#            cbar =plt.colorbar(cp)
...
#           
#    
#            plt.scatter(plot_data[:, 0], plot_data[:, 1], c=km[1])
...
#            fig.savefig('/Users/sevakm/Documents/AIRS_To_Modis/images/' + str(cluster_count) + "/"
#                        + str(round) + '.png')
##            plt.show()
#            plt.close(fig)
#            plt.close(gs1)
...
#    print str(round) + "/" + str(JOB_SIZE)
#data_frame.to_csv('/Users/sevakm/Documents/AIRS_To_Modis/DataFrame/data_sample.csv')

    
#data_frame.to_csv('/Users/sevakm/Documents/AIRS_To_Modis/DataFrame/data2.csv')
#
#        
#    
